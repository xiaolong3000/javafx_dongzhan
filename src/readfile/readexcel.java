...
public class readexcel {
    public static void main(String[] args) {
        String[][] data=new readexcel().result("C:\\base.xls");
     ...
     */
     @Deprecated
    private   String[][] getData(File file, int ignoreRows)
     ...
     * */
    @Deprecated
    private static void oCell(HSSFRow row, short column, String value){
